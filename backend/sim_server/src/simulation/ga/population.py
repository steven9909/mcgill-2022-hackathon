...
class Population:
    ...
    def __init__(self, initial_population: List[Chromosome], start_x, start_y, end_x, end_y):
    ...
    def _select_parents(self):
        fitnesses = np.array([1/chromosome.fitness for chromosome in self.chromosomes])
    ...
    def _crossover(self, parent1: Chromosome, parent2: Chromosome):
        return Chromosome((parent1.force + parent2.force)/2, (parent1.angle + parent2.angle)/2, self.start_x, self.end_x, self.start_y, self.end_y)
